...
{
    /// <summary>
    /// Copied and pasted from the internet. Probably no bugs.
    /// </summary>
    public static class MimeTypeService
    {
        ...
        /// <summary>
        /// Gets a mimetype for the given extension/path
        /// </summary>
        ...
        {
            Ensure.NotNullOrWhiteSpace(extension);
            ...
            return _mappings.TryGetValue(extension, out string? mime) ? mime ?? throw new NullReferenceException("Null mime type retrieved from dicitonary") : "application/octet-stream";
        }
    }
}